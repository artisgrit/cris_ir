...
import {
  ...
  FEEDBACK_PATH,
  GOVERNANCE_POLICIES_PATH,
  HOW_TO_DEPOSIT_PATH,
  PRIVACY_PATH,
} from './info-routing-paths';
import { NotifyInfoComponent } from './notify-info/notify-info.component';
import { ThemedPrivacyComponent } from './privacy/themed-privacy.component';
import { ThemedHowToDepositComponent } from './how-to-deposit/themed-how-to-deposit.component';
import { ThemedDataReuseComponent } from './data-reuse/themed-data-reuse.component';
import { ThemedGovernancePoliciesComponent } from './governance-policies/themed-governance-policies.component';
...
export const ROUTES: Routes = [
  ...
  {
    path: HOW_TO_DEPOSIT_PATH,
    component: ThemedHowToDepositComponent,
    resolve: { breadcrumb: i18nBreadcrumbResolver },
    data: { title: 'info.how-to-deposit.title', breadcrumbKey: 'info.how-to-deposit' },
  },
  {
    path: DATA_REUSE_PATH,
    component: ThemedDataReuseComponent,
    resolve: { breadcrumb: i18nBreadcrumbResolver },
    data: { title: 'info.data-reuse.title', breadcrumbKey: 'info.data-reuse' },
  },
  {
    path: GOVERNANCE_POLICIES_PATH,
    component: ThemedGovernancePoliciesComponent,
    resolve: { breadcrumb: i18nBreadcrumbResolver },
    data: { title: 'info.governance-policies.title', breadcrumbKey: 'info.governance-policies' },
  },
