...
@Component({
  selector: 'ds-workspace-item-admin-workflow-result-list-element',
  styleUrls: ['../../../../../shared/object-list/search-result-list-element/search-result-list-element.component.scss'],
