...
export class DefaultAppConfig implements AppConfig {
  ...
  metaTags: MetaTagsConfig = {
    defaultLogo: '/assets/images/ucu-logo.svg',
    defaultDescription: 'Uganda Christian University Institutional Repository is a comprehensive platform for preserving and providing access to the scholarly and cultural output of Uganda Christian University.',
  };
