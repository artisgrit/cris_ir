...
export const environment: BuildConfig = {
  ...
  metaTags: {
    ...
    defaultDescription: 'Uganda Christian University Institutional Repository is dedicated to preserving and providing access to the scholarly and cultural output of Uganda Christian University.',
  },
